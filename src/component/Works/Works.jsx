  ...
  return (
    <section id="works">
      ...
      <span className="worksDec">
        Welcome to my project portfolio, where innovation meets execution! Below
        is a snapshot of some of my recent projects:
      </span>
      <div className="worksImgs">
        <a href="https://weather-forecast-by-rahul.netlify.app/">
          <img src={project1} alt="" className="worksImg" />
        </a>
        <a href="https://twitterbyme.netlify.app/">
          <img src={project2} alt="" className="worksImg" />
        </a>
        <a href="https://to-do-list4097.netlify.app/">
